...
- задачи на день и постоянные мульти-дедлайны с ручной привязкой к парам и событиям;
- принадлежность дедлайна к теме и скрытие карточки до выбранной даты;
